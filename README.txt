...
Extraia o programa em algum diretório e entre nesse diretório
...
Para executar o arquivo, passe o path relativo à imagem que deseja usar (ex: ./build/program.out build/sc1.png).
